...
const App = () => {
    ...
    const handleSubmit = () => {
        console.log('handle submit', calculatorData);
    ...
    const handleNumbers = (value) => {
        console.log('handle numbers'+" "+ value)
    ...
    const dotOperator = (value) => {
        console.log('dot operator' +" "+ value)
    ...
    const handleOperators = (value) => {
        console.log('handle operators'+" "+value)
    ...
    const handleInput = (value) => {
        const number = numbers.find((numb) => numb===value);
